...
import com.antianbao.serializedvd.user.User;
import com.antianbao.serializedvd.user.UserDaoImpl;
...
public class Login {
    ...
    public void loginManager() {
        System.out.println("********欢迎使用MiniDVD Mgr 4.0 管理系统********");
        System.out.println("------------------------------------------");
        ...
        switch (login) {
            case "1":
                while (true) {
                    ...
                    boolean fg = ui.regist(useName, pwd);
                    if (fg) {
