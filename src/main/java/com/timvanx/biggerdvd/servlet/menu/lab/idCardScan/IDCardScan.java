package com.timvanx.biggerdvd.servlet.menu.lab.idCardScan;

import com.alibaba.fastjson.JSON;
import com.timvanx.biggerdvd.util.BaiduOCR;
 ...
 * @author TimVan
 */
@WebServlet(name = "IDCardScan",
        urlPatterns = {"/ftm/html/menu/lab/IDCardScan.do"}
        , loadOnStartup = 1)
public class IDCardScan extends HttpServlet {
                ...
                if (formItems != null && formItems.size() > 0) {
                    ...
                    for (FileItem item : formItems) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            retval = object.idImageToIDCard(filePath);
