 ...
 * @author TimVan
 */
@WebServlet(name = "GetAllHiddenDVDs",
        urlPatterns = {"/ftm/html/menu/GetAllHiddenDVDs.do"}, loadOnStartup = 1)
public class GetAllHiddenDVDs extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ArrayList<DVD> dvdArr = DVD
                .loadDVDInfosByArray(true,pageNum,pageSize,tableWhere);
        int totalNum = DVD.countDVDs(true,tableWhere);
