package com.timvanx.biggerdvd.servlet.menu.lab;
 ...
 * @author TimVan
 */
@WebServlet(name = "StuCardScan",
        urlPatterns = {"/ftm/html/menu/lab/StuCardScan.do"}
        , loadOnStartup = 1)
public class StuCardScan extends HttpServlet {
                ...
                if (formItems != null && formItems.size() > 0) {
                    ...
                    for (FileItem item : formItems) {
                        ...
                        if (!item.isFormField()) {
                            ...
                            retval = object.imageToStuCard(filePath);
