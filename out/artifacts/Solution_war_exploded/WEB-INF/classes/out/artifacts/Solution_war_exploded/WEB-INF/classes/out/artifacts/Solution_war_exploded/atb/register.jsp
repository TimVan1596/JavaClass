...
<form action="Register.do" method="post">
    ...
    <p>
        确认密码：<input name="cpassword" type="password" title="cpassword" style="text-align: left; width: 150px;"/>
    </p>
    <p>
        绑定手机：<input name="phone" type="text" title="phone" style="text-align: left; width: 150px;"/>
    </p>
    <p>
