...
<input type="text" name="searchs"> <span class="glyphicon glyphicon-search"></span><input type="submit" value="搜一搜">
</form>
...
<td>${book.booktime}</td>
<td><a href="CheckBook?param=xiugai&id=${book.bookid}">修改</a></td>
