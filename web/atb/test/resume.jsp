...
<form class="layui-form" action="" id="demoForm">
    <div class="panel">
    ...
    <div class="panel">
        ...
        <div class="panelContent">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="address" required  lay-verify="required" placeholder="请输入现居地址地址" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel">
        ...
        <div class="panelContent">
            <div class="layui-form-item">
                ...
                <button class="layui-btn" id="select">(重新)选择图片</button>
                <button class="layui-btn" id="add">(追加)图片</button>
