        ...
        <tr>
            <td colspan = '8' align="right">
                ...
                <%
                    if(page1 == 1){
                %>
                <a href = './atbpaging.do?page=1&search=<%=search%>'>上一页</a>
                <%
                }else{
                %>
                <a href = './atbpaging.do?page=<%= page1-1%>&search=<%=search%>'>上一页</a>
                <%
                    }
                %>
                <%
                ...
                %>
                <a href = './atbpaging.do?page=<%= i %>&search=<%=search%>'><%= i %></a>
                <%
                    }
                %>
                <%
                    if(page1 == pages){
                %>
                <a href = './atbpaging.do?page=<%= pages%>&search=<%=search%>'>下一页</a>
                <%
                }else{
                %>
                <a href = './atbpaging.do?page=<%= page1+1%>&search=<%=search%>'>下一页</a>
                <%
                    }
                %>
